...
\setlength\intextsep{1truemm}
\setlength\dblfloatsep{2truemm}
\setlength\dbltextfloatsep{2truemm}
...
\AtBeginDocument{%
    ...
    %
    \setlength\abovedisplayskip{2truemm}    % equation setting
    \setlength\belowdisplayskip{2truemm}    % equation setting
}
